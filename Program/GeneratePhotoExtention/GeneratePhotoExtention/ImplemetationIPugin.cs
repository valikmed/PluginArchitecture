...
public class ImplemetationIPugin : IPlugin
{
    public ImplemetationIPugin()
    {
    }

    string IPlugin.Title => throw new NotImplementedException();

    string IPlugin.Description => throw new NotImplementedException();

    void IPlugin.DoSomething()
    {
